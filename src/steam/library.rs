...
pub(crate) fn is_game_steam_app_id(
...
pub(crate) fn collect_library_folders(steam_paths: &[PathBuf]) -> Vec<PathBuf> {
...
pub(crate) fn parse_acf_values(content: &str) -> HashMap<String, String> {
...
pub(crate) fn parse_userdata(steam_paths: &[PathBuf]) -> (HashMap<u32, u64>, HashMap<u32, u32>) {
